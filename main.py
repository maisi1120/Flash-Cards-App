...
check = Button(image=check_image, highlightbackground=BACKGROUND_COLOR, command=is_known)
check.grid(column=1, row=1)

cross_image = PhotoImage(file="images/wrong.png")
cross = Button(image=cross_image, highlightbackground=BACKGROUND_COLOR, command=next_card)
